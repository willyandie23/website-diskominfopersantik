                ...
                <div class="card-body p-4">
                    <form action="{{ route('agenda.update', $agenda) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror">{{ old('keterangan', $agenda->keterangan) }}</textarea>
                            @error('keterangan')
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <button class="btn btn-outline-danger btn-sm w-100 btn-delete-edit"
                        data-url="{{ route('agenda.destroy', $agenda) }}" data-name="{{ $agenda->title }}">
