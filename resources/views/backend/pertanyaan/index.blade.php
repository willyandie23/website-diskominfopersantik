...
@push('css')
    <style>
        ...
        #pertanyaanTable tbody tr:hover {
            background: #f9fafb;
        }
                    ...
                    <tbody>
                        @forelse ($pertanyaans as $item)
                            <tr>
                                ...
                                <td>
                                    @if ($item->is_active)
                                        <span class="badge-active"><i class="fas fa-circle" style="font-size:0.4rem;"></i>
                                            Aktif</span>
                                    @else
                                        <span class="badge-inactive"><i class="fas fa-circle" style="font-size:0.4rem;"></i>
                                            Non-Aktif</span>
                                    @endif
                                </td>
                                <td class="text-center">
                                    <a href="{{ route('pertanyaan.edit', $item) }}" class="btn-action btn-edit-action me-1"
                                        title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('pertanyaan.destroy', $item) }}" method="POST" class="d-inline"
