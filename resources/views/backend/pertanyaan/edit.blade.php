    ...
    <div class="form-card card">
        ...
        <div class="card-body">
            <form action="{{ route('pertanyaan.update', $pertanyaan) }}" method="POST">
                ...
                <div class="mb-3">
                    <label for="pertanyaan_text" class="form-label fw-semibold">Pertanyaan <span
                            class="text-danger">*</span></label>
                    <textarea name="pertanyaan" id="pertanyaan_text" class="form-control @error('pertanyaan') is-invalid @enderror"
                        rows="4">{{ old('pertanyaan', $pertanyaan->pertanyaan) }}</textarea>
                    @error('pertanyaan')
