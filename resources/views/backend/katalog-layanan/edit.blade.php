            ...
            <div class="col-lg-9">
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('katalog-layanan.update', $katalogLayanan) }}" method="POST"
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" id="title"
                                        ...
                                        value="{{ old('title', $katalogLayanan->title) }}"
                                ...
                                <div class="mb-0">
                                    ...
                                    <textarea name="deskripsi" id="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror"
                                        placeholder="Tuliskan deskripsi lengkap layanan...">{{ old('deskripsi', $katalogLayanan->deskripsi) }}</textarea>
                                    @error('deskripsi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-section">
                                ...
                                @if ($katalogLayanan->image)
                                    <div class="mb-3">
                                        ...
                                        <div class="current-image-wrapper">
                                            ...
                                            <img src="{{ Storage::url($katalogLayanan->image) }}"
                                                alt="{{ $katalogLayanan->title }}">
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="mb-0">
                                    <label
                                        class="form-label fw-semibold">{{ $katalogLayanan->image ? 'Ganti Gambar' : 'Upload Gambar' }}</label>
                                    ...
                                    <div class="col-md-6 mb-3 mb-md-0">
                                        ...
                                        <div class="input-icon-group">
                                            ...
                                            <input type="url" name="url_video" id="url_video"
                                                ...
                                                value="{{ old('url_video', $katalogLayanan->url_video) }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-icon-group">
                                            ...
                                            <input type="url" name="url_website" id="url_website"
                                                ...
                                                value="{{ old('url_website', $katalogLayanan->url_website) }}"
