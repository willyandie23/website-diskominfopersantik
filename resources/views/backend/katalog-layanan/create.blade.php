                    ...
                    <form action="{{ route('katalog-layanan.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" id="title" class="form-control form-control-lg @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="Masukkan judul layanan...">
                                @error('title')
                            ...
                            <div class="mb-0">
                                ...
                                <textarea name="deskripsi" id="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" placeholder="Tuliskan deskripsi lengkap layanan...">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3 mb-md-0">
                                    ...
                                    <div class="input-icon-group">
                                        ...
                                        <input type="url" name="url_video" id="url_video" class="form-control @error('url_video') is-invalid @enderror" value="{{ old('url_video') }}" placeholder="https://youtube.com/...">
                                    </div>
                                    @error('url_video')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-icon-group">
                                        ...
                                        <input type="url" name="url_website" id="url_website" class="form-control @error('url_website') is-invalid @enderror" value="{{ old('url_website') }}" placeholder="https://example.com">
                                    </div>
                                    @error('url_website')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
