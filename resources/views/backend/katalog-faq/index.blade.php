                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('katalog-faq.edit', $faq) }}" class="btn btn-sm btn-warning text-white">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('katalog-faq.destroy', $faq) }}" method="POST" class="d-inline form-delete">
                                @csrf @method('DELETE')
