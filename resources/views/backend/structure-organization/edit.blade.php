        ...
        <div class="col-12 col-xl-12">
            <div class="main-card card">
                <div class="card-header d-flex align-items-center gap-2">
                    <div
                        style="width:36px;height:36px;background:#fffbeb;border-radius:9px;display:flex;align-items:center;justify-content:center;">
                    ...
                    <div>
                        ...
                        <small class="text-muted" style="font-size:0.76rem;">Perbarui informasi anggota struktur
                            organisasi</small>
                    </div>
                </div>

                <div class="card-body">
                    <form action="{{ route('struktur-organisasi.update', $strukturOrganisasi) }}" method="POST"
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nama"
                                    ...
                                    value="{{ old('nama', $strukturOrganisasi->nama) }}" placeholder="Masukkan nama lengkap"
                                    required>
                                @error('nama')
                            ...
                            @if ($strukturOrganisasi->gambar)
                                <div class="col-md-4">
                                    ...
                                    <div class="current-photo-wrapper">
                                        ...
                                        <img src="{{ $strukturOrganisasi->gambar_url }}"
