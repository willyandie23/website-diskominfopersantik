...
@push('css')
    <style>
        ...
        #structureTable tbody tr:last-child td {
            border-bottom: none;
        }
...
@section('content')
    ...
    <div class="main-card card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <span class="badge"
                style="background:#eff6ff; color:#1d4ed8; font-size:0.78rem; padding:5px 10px; border-radius:8px;">
                    ...
                    <tbody>
                        @forelse ($structures as $structure)
                            <tr>
                                ...
                                <td>
                                    @if ($structure->gambar)
                                        <img src="{{ $structure->gambar_url }}" alt="{{ $structure->nama }}"
                                            class="member-avatar">
                                    @else
                                ...
                                <td>
                                    <div class="member-info">
                                        ...
                                        <div class="member-jabatan"><i class="fas fa-briefcase me-1"
                                                style="color:#9ca3af;font-size:0.7rem;"></i>{{ $structure->jabatan }}</div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('struktur-organisasi.edit', $structure) }}"
                                        class="btn-action btn-edit-action me-1" title="Edit Data">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('struktur-organisasi.destroy', $structure) }}" method="POST"
                                        class="d-inline" id="form-delete-{{ $structure->id }}">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn-action btn-delete-action" title="Hapus Data"
                            ...
                            <tr>
                                <td colspan="7">
                                    <div class="empty-state">
                                        ...
                                        <small>Mulai tambahkan data dengan klik tombol <strong>Tambah Data
                                                Baru</strong></small>
                                    </div>
                                </td>
                            </tr>
