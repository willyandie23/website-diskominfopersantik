        ...
        <div class="col-12 col-xl-12">
            ...
            <div class="main-card card">
                <div class="card-header d-flex align-items-center gap-2">
                    <div
                        style="width:36px;height:36px;background:#eef2ff;border-radius:9px;display:flex;align-items:center;justify-content:center;">
                    ...
                    <form action="{{ route('struktur-organisasi.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="photo-upload-area" id="uploadArea">
                            <input type="file" name="gambar" id="photoInput"
                                class="@error('gambar') is-invalid @enderror" accept="image/*">
