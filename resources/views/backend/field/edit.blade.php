...
@push('styles')
    <style>
        ...
        .bidang-form-card {
            ...
            background: #fff;
            margin-top: -20px;
            /* sedikit naik agar overlap bagus */
        }
            ...
            <form action="{{ route('bidang.update', $bidang) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <textarea name="deskripsi_bidang" id="deskripsi_bidang"
                        class="form-control form-control-modern @error('deskripsi_bidang') is-invalid @enderror" rows="8">{{ old('deskripsi_bidang', $bidang->deskripsi_bidang) }}</textarea>
