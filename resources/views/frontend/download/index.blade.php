                    ...
                    <div class="col-md-6">
                        <form action="{{ route('frontend.download.index') }}" method="GET">
                            <div class="input-group search-box">
                                <input type="text" name="search" class="form-control" placeholder="Cari file..."
        ...
        <div class="container my-5">
            ...
            @if (request('search'))
                <div class="mb-4">
                    ...
                    <a href="{{ route('frontend.download.index') }}" class="ms-2 text-decoration-none"
