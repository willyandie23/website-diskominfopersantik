...
@section('content')
    <style>
        ...
        .org-hero .breadcrumb-item a {
            color: var(--primary, #3b82f6);
            text-decoration: none;
        }

        .org-hero .breadcrumb-item.active {
            color: #94a3b8;
        }
        ...
        .peg-sekretaris .photo-frame {
            border-color: #14a3a3;
        }

        .peg-kabid .photo-frame {
            border-color: #a855f7;
        }

        .peg-kasubag .photo-frame {
            border-color: #f59e0b;
        }

        .peg-staff .photo-frame {
            border-color: #9ca3af;
        }
        ...
        .peg-sekretaris .no-photo {
            background: linear-gradient(135deg, #0d6e6e, #14a3a3);
        }
        ...
        .peg-kepala .peg-jabatan {
            color: #b8860b;
        }

        .peg-sekretaris .peg-jabatan {
            color: #0d6e6e;
        }

        .peg-kabid .peg-jabatan {
            color: #8e44ad;
        }

        .peg-kasubag .peg-jabatan {
            color: #d97706;
        }

        .peg-staff .peg-jabatan {
            color: #6b7280;
        }
    ...
    <!-- ══════ HERO SECTION ══════ -->
    <section class="position-relative overflow-hidden mb-4"
        style="background: linear-gradient(135deg, #1e3a5f 0%, #0d2137 60%, #0a1628 100%); padding: 80px 0 60px;">
        {{-- Decorative Background Elements --}}
        <div style="position:absolute;top:0;left:0;width:100%;height:100%;overflow:hidden;pointer-events:none;">
            <div
                style="position:absolute;top:-80px;right:-80px;width:300px;height:300px;border-radius:50%;background:rgba(255,255,255,0.03);">
            </div>
            <div
                style="position:absolute;bottom:-120px;left:-60px;width:400px;height:400px;border-radius:50%;background:rgba(255,255,255,0.02);">
            </div>
            <div
                style="position:absolute;top:40%;left:50%;width:600px;height:1px;background:linear-gradient(90deg,transparent,rgba(255,255,255,0.06),transparent);transform:translateX(-50%) rotate(-12deg);">
            </div>
            <div
                style="position:absolute;top:55%;left:50%;width:500px;height:1px;background:linear-gradient(90deg,transparent,rgba(255,255,255,0.04),transparent);transform:translateX(-50%) rotate(-12deg);">
            </div>
        </div>
        <div class="container position-relative" style="z-index:2;">
            <div class="text-center">
                ...
                {{-- Subtitle --}}
                <p
                    style="font-size:1.05rem;color:rgba(255,255,255,0.55);font-weight:400;margin-bottom:28px;max-width:500px;margin-left:auto;margin-right:auto;">
                    ...
                    <ol class="breadcrumb justify-content-center mb-0"
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('main.index') }}"
                                style="color:rgba(255,255,255,0.6);text-decoration:none;font-size:0.88rem;transition:color .2s;">
                                <i class="fa fa-home" style="margin-right:4px;font-size:0.8rem;"></i> Beranda
                            </a>
                        </li>
                        <li class="breadcrumb-item active" style="color:#64b5f6;font-size:0.88rem;font-weight:500;"
                            aria-current="page">
                            Struktur Organisasi
                        </li>
                    </ol>
