...
@section('content')
    <style>
        ...
        .field-info-card .ck-content p {
            margin-bottom: 10px;
        }

        .field-info-card .ck-content p:last-child {
            margin-bottom: 0;
        }

        .field-info-card .ck-content h2,
        .field-info-card .ck-content h3 {
            color: var(--primary-dark);
            margin-top: 20px;
        }

        .field-info-card .ck-content ul,
        .field-info-card .ck-content ol {
            padding-left: 24px;
        }

        .field-info-card .ck-content img {
            max-width: 100%;
            height: auto;
            border-radius: 8px;
            margin: 12px 0;
        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('frontend.structure-organization.index') }}">Struktur
                            Organisasi</a></li>
        ...
        <div class="container">
            ...
            <div class="field-info-card">
                ...
                <div class="ck-content">
                    {!! $field->deskripsi_bidang ??
                        '<p>Informasi mengenai ' . e($field->nama_bidang) . ' pada struktur organisasi.</p>' !!}
                </div>
                    ...
                    @foreach ($field->structures as $pegawai)
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="pegawai-card">
                                <img src="{{ $pegawai->gambar_url }}" alt="{{ $pegawai->nama }}" class="card-img"
                                    loading="lazy">
                                <div class="card-body">
                                    <h5>{{ $pegawai->nama }}</h5>
